<template>
  <Page id="page-container" :header="page.label" :subheader="page.sublabel">
...
const params = { version: 6, name: "search", label: "CIV-6 DATABASE", sublabel: "Search for internal configuration keys" };
